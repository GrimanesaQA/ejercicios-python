def precioTotalProducto(nombre_producto, precio_por_unidad, cantidad_de_producto, descuento_porcentaje, iva_porcentaje):
...
resultado = precioTotalProducto(nombre_producto, precio_por_unidad, cantidad_de_producto, descuento_porcentaje, iva_porcentaje)
print(resultado)